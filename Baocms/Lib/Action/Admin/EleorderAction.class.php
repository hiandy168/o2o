...
class EleorderAction extends CommonAction {
    ...
    public function index() {
        ...
        // 保存搜索信息到cookie中
        if(cookie(md5('EleOrderSearchIndexMessage'))){
            $map = cookie(md5('EleOrderSearchIndexMessage'));
            if(cookie(md5('EleOrderSearchIndexMessageOrder'))){
                $map['name'] = cookie(md5('EleOrderSearchIndexMessageOrder'));
            }
        }
