...
class ShopcateAction extends CommonAction {
    ...
    private $create_fields = array('cate_name','d1','d2','d3','title', 'orderby','open_url','seller_url','auth');
    private $edit_fields = array('cate_name','d1','d2','d3','title', 'orderby','open_url','seller_url','auth');
    ...
    public function lists(){
        $shopcate_mod = D("Shopcate");
        $this->lists = $shopcate_mod->where(array('parent_id'=>0))->select();
        //var_dump($this->lists);
        $this->display();
    }
