...
class TuanAction extends CommonAction {
    ...
    public function index() {
        ...
        switch ($price) {
            case 1:
                $map['tuan_price'] = array('ELT', '50');
                $this->assign('pricestr', '50元以下');
                $linkArr['price'] = $price;
                break;
            case 2:
                $map['tuan_price'] = array('between', '50.01,100');
                $this->assign('pricestr', '50-100元');
                $linkArr['price'] = $price;
                break;
            case 3:
                $map['tuan_price'] = array('between', '100.01,200');
                $this->assign('pricestr', '100-200元');
                $linkArr['price'] = $price;
                break;
            case 4:
                $map['tuan_price'] = array('between', '200.01,300');
                $this->assign('pricestr', '200-300元');
                $linkArr['price'] = $price;
                break;
            case 5:
                $map['tuan_price'] = array('EGT', '300.01');
