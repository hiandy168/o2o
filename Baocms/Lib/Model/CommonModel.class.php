...
class CommonModel extends Model{
    ...
    public function _settoken($value){
        $this->token =$value;
    }
    /**
     *描述：获得所有子集
     */
    public function getAllChildren($pid,$fix='pid',$id='id',$html="--",$forlevel=0,$level=0){
      import("ORG.Util.Category");
      $cate =$this->fetchAll();
      return Category::unlimitedForLevel($cate,$html,$pid,$level,$fix,$id,$forlevel);
